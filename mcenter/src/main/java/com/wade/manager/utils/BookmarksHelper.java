package com.wade.manager.utils;
...
public class BookmarksHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        addBookmarkOnCreate(db, new Bookmark("Int SDCard", Environment.getExternalStorageDirectory().getPath()));
        addBookmarkOnCreate(db, new Bookmark("Ext SDCard", "/storage/sdcard1"));
        addBookmarkOnCreate(db, new Bookmark("USB", "/storage/usbdisk0"));
    }
